...
[![My Skills](https://skillicons.dev/icons?i=next,tailwind,react,ts,nodejs,express,mongo,spring,java,postgresql,git,linux,bash,docker,gcp)](https://skillicons.dev)
